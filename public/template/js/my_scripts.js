...
function takeSnapShot(){
	...
	canvas.width = 320; //canvas.width = 640; //canvas.width = video.videoWidth;
	canvas.height = 240; //canvas.height = 480; //canvas.height = video.videoHeight;
    ...
    document.querySelector('#imagemassociadobase64').value = dataURI;

    document.querySelector('#results').innerHTML = '<img id="base64image" src="'+dataURI+'"/>';
    //document.querySelector('#results').innerHTML = 'OI';
