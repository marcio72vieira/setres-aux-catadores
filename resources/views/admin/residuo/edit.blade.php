...
@section('conteudo-principal')
    <!-- Page Heading -->
    <h1 class="h3 mb-4 text-gray-800">Gerenciar / Resíduos Sólidos / Editar</h1>
        ...
        <div class="col-lg-12 order-lg-1">
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    ...
                    <form action="{{route('admin.residuo.update', $residuo->id )}}" method="POST" autocomplete="off">
                        @csrf
                        @method('PUT')
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="form-group focused">
                                        ...
                                        <input type="text" class="form-control" id="nome" name="nome" value="{{old('nome', $residuo->nome)}}" required>
                                        @error('nome')
