        ...
        <tbody>
            @foreach ($pontocoletas as $pontocoleta)
                <tr>
                    ...
                    <td>{{$pontocoleta->endereco.", ".$pontocoleta->numero.", ".$pontocoleta->bairro.", ".$pontocoleta->COMPLEMENTO.", ".$pontocoleta->cidade}}</td>
                    <td>
                        ...
                        <a class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#formDelete{{$pontocoleta->id}}">
                        ...
                        <div class="modal fade" id="formDelete{{$pontocoleta->id}}" tabindex="-1" aria-labelledby="formDeleteLabel" aria-hidden="true">
                            ...
                            <div class="modal-content">
                                ...
                                <h5 class="modal-title" id="formDeleteLabel">Deletar pontocoleta</h5>
