...
<body>
    ...
    <div>
        <table style="width: 627px; border-collapse: collapse;">
            <tr>
                <td style="width: 360px;" class="label-ficha">NOME (tipo)</td>
                <td style="width: 117px;" class="label-ficha">CARTEIRA (validade)</td>
                <td style="width: 100px;" class="label-ficha">DATA DE NASCIMENTO</td>
                <td style="width: 50px;" class="label-ficha">SEXO</td>
            </tr>
            <tr>
                <td style="width: 360px;" class="dados-ficha">{{$associado->nome}} ({{$associado->tipo}}) </td>
                <td style="width: 117px;" class="dados-ficha">{{$associado->carteiraemitida == 1 ? 'sim'.'  ('.mrc_turn_data($associado->carteiravalidade).')' : 'não'}}</td>
