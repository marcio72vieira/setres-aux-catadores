                                ...
                                <div class="col-lg-3">
                                    <div class="form-group focused">
                                        ...
                                        <div style="margin-top: 5px">
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" name="carteiraemitida" id="carteiraemitidasim" value="1" {{old('carteiraemitida') == '1' ? 'checked' : ''}} required>
                                                <label class="form-check-label" for="carteiraemitidasim">Sim</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" name="carteiraemitida" id="carteiraemitidanao" value="0" {{old('carteiraemitida') == '0' ? 'checked' : ''}} required>
